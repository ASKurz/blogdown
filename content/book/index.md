...
## *Applied Longitudinal Data Analysis in brms and the tidyverse*, version 0.0.4
...
* You can find my ebook at https://solomon.quarto.pub/alda/
...
* You can find my ebook at https://solomon.quarto.pub/immcpa2/
...
## *Statistical rethinking with brms, ggplot2, and the tidyverse*, version 1.4.0

This is a translation of the code from the first edition of Richard McElreath's *Statistical rethinking*.
* You can find my ebook at https://solomon.quarto.pub/sr/
* You can find information about the original book by McElreath [here](http://xcelab.net/rm/statistical-rethinking/).

## *Statistical rethinking 2 with brms and the tidyverse*, version 0.5.0

This is a translation of the code from the second edition of Richard McElreath's *Statistical rethinking*.
* You can find my ebook at https://solomon.quarto.pub/sr2/
* You can find information about the original book by McElreath [here](http://xcelab.net/rm/statistical-rethinking/).

## *Statistical rethinking 2 with rstan and the tidyverse*, version 0.0.3.1

This is a translation of the code from the second edition of Richard McElreath's *Statistical rethinking*, but with **rstan**.
* You can find my ebook at https://solomon.quarto.pub/sr2rstan/
* You can find information about the original book by McElreath [here](http://xcelab.net/rm/statistical-rethinking/).
