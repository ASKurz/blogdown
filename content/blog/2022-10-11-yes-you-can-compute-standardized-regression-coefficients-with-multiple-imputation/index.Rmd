...
We use the `pool()` function to pool the results from the 100 MI data sets according to Rubin's rules [@rubinMultipleImputationNonresponse1987; @little2019statistical].
...
```{r echo = FALSE}
blogdown::shortcode('tweet',  user = "mattansb", id = '1578447175998373893')
```

While I'm at it, it was [Isabella R. Ghement](http://www.ghement.ca) who directed me to the van Ginkel paper.

```{r echo = FALSE}
blogdown::shortcode('tweet', user = "IsabellaGhement", id = '1578557862733045760')
```
...
# use the function to extract the MI draws
tibble(k = 1:100) %>% 
