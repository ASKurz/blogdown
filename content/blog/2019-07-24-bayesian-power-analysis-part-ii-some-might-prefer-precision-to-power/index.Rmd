...
# save(s4, file = "sims/s4.rda")
# save(s5, file = "sims/s5.rda")
# save(s6, file = "sims/s6.rda")
# save(s7, file = "sims/s7.rda")
# save(s8, file = "sims/s8.rda")
# save(s9, file = "sims/s9.rda")
# save(n_sim, file = "sims/n_sim.rda")
...
```{r fit, warning = F, message = F, results = "hide"}
# define the means
mu_c <- 0
mu_t <- 0.5
...
ggsave("ci-width-featured.jpg", width = 4, height = 3.5, units = "in")
```
