...
* with **R** [@R-base] and the **blogdown** [@R-blogdown] package,
* with GitHub,
* and with Netlify.
...
For an exhaustive introduction to **blogdown**, you have the ebook by Xie, Hill, and Thomas [-@xieBlogdown2017], [*blogdown: Creating websites with R markdown*](https://bookdown.org/yihui/blogdown/).

### GitHub.

If you're new to GitHub, let the great Jenny Bryan lead you, [here](http://happygitwithr.com/) [@bryanHappyGitGitHub2020].
...
ggsave("fancy-scatterplot-featured.jpg", width = 3.5, height = 3.5, units = "in")
```
...
```{r echo = FALSE}
blogdown::shortcode('tweet', user = "SolomonKurz", id = '1602690155986427904')
```
