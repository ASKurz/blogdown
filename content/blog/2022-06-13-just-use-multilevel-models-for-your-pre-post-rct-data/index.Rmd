...
```{r, echo = F}
# save(sim.4, file = "sims/sim.4.rda")
# save(sim.8, file = "sims/sim.8.rda")
...
Edited on January 2, 2023, to acknowledge the related simulation study by @oConnell2017methods. See footnote #3 for details.
...
```{r echo = FALSE}
blogdown::shortcode('tweet', user = "SolomonKurz", id = '1533905226519937024')
```
...
ggsave("mlm-ancova-featured.jpg", width = 3.55, height = 3.5, units = "in")
```
