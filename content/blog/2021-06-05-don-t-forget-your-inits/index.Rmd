...
theme_set(
  theme_gray(base_size = 8) +
    theme(
      ...
      legend.box.background = element_blank(),
      legend.key = element_blank(),
      panel.background = element_rect(fill = "#ebe8dc", color = "transparent"),
      panel.grid = element_blank(),
      plot.background = element_rect(fill = "#f2f0e9", color = "transparent")
    )
)
...
# &
#   theme(panel.background = element_rect(fill = "#ebe8dc", color = "transparent"),
#         plot.background = element_rect(fill = "#f2f0e9", color = "transparent"))

ggsave("trace-plot-featured.jpg", width = 3.6, height = 3.5, units = "in")
```
