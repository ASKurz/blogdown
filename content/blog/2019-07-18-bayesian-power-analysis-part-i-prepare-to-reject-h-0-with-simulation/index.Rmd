...
```{r, echo = F}
# save(fit, file = "fits/fit.rda")
# save(updated_fit, file = "fits/updated_fit.rda")

# save(s, file = "sims/s.rda")
# save(s2, file = "sims/s2.rda")
# save(s3, file = "sims/s3.rda")

# save(t1, file = "sims/t1.rda")
# save(t2, file = "sims/t2.rda")
# save(t3, file = "sims/t3.rda")
# save(t4, file = "sims/t4.rda")
# save(t5, file = "sims/t5.rda")
# save(t6, file = "sims/t6.rda")

load("fits/fit.rda")
load("fits/updated_fit.rda")
...
ggsave("h0-iterations-featured.jpg", width = 6, height = 3.5, units = "in")
```
