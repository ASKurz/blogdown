...
This isn't a fluke, and it has also been observed by scholars within the methodological literature [e.g., @clifton2019correlation; @laird1983further]. Note that the precision with which we've estimated that $\beta_2$ parameter is the same in the two ANCOVA models, too; they have the same standard error.
...
Change-scores have a special connection to regression to the mean (RTM). If you need a refresher, RTM comes to us from the work of Sir Francis Galton. Happily, the **UsingR** package [@R-UsingR] contains a copy of the height data Galton. presented in his [-@galton1886regression] paper. The data file been saved as `galton`, which we'll go ahead and load.
...
[^12]: Apparently the Skellam distribution can be handy in sports analytics, like modeling differences in goals [see @karlis2009bayesian]. 
