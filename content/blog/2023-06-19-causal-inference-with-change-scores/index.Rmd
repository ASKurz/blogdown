...
This isn't a fluke, and it has also been observed by scholars within the methodological literature [e.g., @clifton2019correlation; @laird1983further]. Note that the precision with which we've estimated those $\hat \beta_2$'s is the same in the two ANCOVA models, too; they have the same standard error.
